...
test_command="./test/task/e2e-simple.sh && ./test/task/e2e-kitchensink.sh && ./test/task/e2e-installs.sh"
case ${test_suite} in
  "all")
    ;;
  "simple")
    test_command="./test/task/e2e-simple.sh"
    ;;
  "kitchensink")
    test_command="./test/task/e2e-kitchensink.sh"
    ;;
  "installs")
    test_command="./test/task/e2e-installs.sh"
    ;;
  *)
    ;;
esac
