...
let appDevWebpackConfig = {}

const hasAppWebpackDevConfig = fs.existsSync(paths.appWebpackDevConfig)
const hasAppDevServerConfig = fs.existsSync(paths.appDevServerConfig)

if (hasAppWebpackDevConfig) {
    appDevWebpackConfig = require(paths.appWebpackDevConfig)
}
...
const combinedWebpackConfig = { ...devWebpackConfig, ...appDevWebpackConfig }
const combinedDevServerConfig = { ...devServerOptions, ...appDevServerOptions }

// Add the HMR entry points to the combinedWebpackConfig.
WebpackDevServer.addDevServerEntrypoints(combinedWebpackConfig, combinedDevServerConfig)
